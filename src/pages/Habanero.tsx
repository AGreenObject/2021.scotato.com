    ...
    <Stack p={[8, 12]} spacing={[4, 6]} mx="auto" maxW={960}>
      ...
      <Page>
        ...
        <Section title="Architecture">
          <Text>The original app was built with SwiftUI and iCloud, however ultimately I wanted to be able to provide a Web and Android app, so I switched over to Redwood.js with PostgreSQL.</Text>
        ...
        <Section title="Hiatus">
          ...
          <Text>I'm considering this project on hold for now as I explore the Web3 world which offers new and interesting authentication methods and some potential NFT/Recipe mashups.</Text>
        </Section>
      </Page>
    </Stack>
  )
